                    ...
                    <div class="col">
                        <div class="card feature-card">
                            <div class="card-header feature-card-header text-center">
                                ...
                                <h4 class="d-inline-block ms-2">Manage Account</h4>
                            </div>
                            <div class="card-body feature-card-body">
                                <a href="${pageContext.request.contextPath}/admin/manageacc">
                                    <i class="bi bi-people-fill"></i>User List
                                </a>
                                <a href="${pageContext.request.contextPath}/admin/manageacc?action=deletedList" class="d-block mt-2">
                                    <i class="bi bi-person-x-fill"></i>Inactive List
                                </a>
                            </div>
                        </div>
                    </div>
