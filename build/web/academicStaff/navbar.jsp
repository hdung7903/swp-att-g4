        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="${pageContext.request.contextPath}/acad/home?id=${sessionScope.accountId}" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Home"><i class="fa-solid fa-house"></i> Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="${pageContext.request.contextPath}/acad/createClass?id=${sessionScope.accountId}" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Create Class"><i class="fa-regular fa-calendar"></i> Create Class</a>
                        </li>
                        <li class="nav-item">
