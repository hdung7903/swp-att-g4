<%-- 
    ...
    Created on : Feb 27, 2024, 10:15:46 PM
    Author     : Admin
--%>
...
<html lang="en">
    <head>
        ...
        <!-- Font Icon -->
        <link rel="stylesheet" type="text/css" href="../css/fonts/material-icon/css/material-design-iconic-font.min.css">
        <link rel="stylesheet" type="text/css" href="../css/vendor/jquery-ui/jquery-ui.min.css">
            ...
            <section class="signup">
                <div class="container">
                    <div class="signup-content">
                        <form method="POST" id="signup-form" class="signup-form" action="${pageContext.request.contextPath}/acad/createClass">
                            <h2>Create Class</h2>
<!--                            <p style="color: red; font-size: 18px" >${mess}</p>-->
                            <p style="color: red; font-size: 18px" >${sessionScope.messAddStu}</p>
                            <div class="form-row">
