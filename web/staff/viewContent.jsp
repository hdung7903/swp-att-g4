...
<html>
    ...
    <body>
        <div class="container">
            ...
            <form action="${pageContext.request.contextPath}/staff/approve" method="post">
                <input type="hidden" name="appId" value="${application.id}">
                <button type="submit" class="btn btn-success" name="approve" onclick="showMessage('Cập nhật thành công')">Approve</button>
                <button type="submit" class="btn btn-danger" name="reject" onclick="showMessage('Cập nhật thành công')">Reject</button>
                <br>
