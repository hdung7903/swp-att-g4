    ...
    <div class="mt-5">
        <div class="container">
            ...
            <div class="w-50 bg-white shadow mx-auto p-5" style="height: 600px; border-radius: 15px;">
              ...
              <form action="${pageContext.request.contextPath}/admin/editinfor" method="POST" id="addForm" >
                <input type="text" name="action" value="edit" hidden required>
                <div class="row">
                 <div class="mt-3 col-6">
                    <label for="" class="label_option fs-5 fw-blod">Id</label>
                    <input autofocus type="text" name="id" class="w-100 p-2 border-0" 
                           style="background-color: #f2f2f2; border-radius: 2px;" required value="$${ins.getId()}">
                 </div>
                 <div class="mt-3 col-6">
