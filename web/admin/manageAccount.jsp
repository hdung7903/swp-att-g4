...
<body>
    ...
    <div class="container mt-5">
        <div class="d-flex align-items-center justify-content-between">
            <h3>List Account</h3>
            <div class="">
                <a class="bg-success px-5 shadow mx-2 rounded text-decoration-none py-2 text-white" href="createacc?action=add">Add</a>
        ...
        <div class="mt-3 d-flex align-items-center justify-content-between">
            ...
            <div class="d-flex align-items-center">
                ...
                <button type="submit" class="mr-2">Search</button>
