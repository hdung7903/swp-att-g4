 ...
 * @author leduy
 */
public class ViewStudentFeedbackController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Group> groupList = gdb.getStudentGroup(student_id);
        SCMDBContext group = new SCMDBContext();
        ArrayList<StudentClassMapping> g = group.getGroupbyStudent(student_id);
        ...
        request.getRequestDispatcher("../academicStaff/viewFeedback.jsp").forward(request, response);
    }
