 ...
 * @author leduy
 */
public class ViewStudentAttendanceStatistic extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("csmId") != null) {
            ...
            request.getRequestDispatcher("../staff/attreport.jsp").forward(request, response);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ViewStudentAttendanceStatistic.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
