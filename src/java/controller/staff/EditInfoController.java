...
import org.eclipse.tags.shaded.org.apache.bcel.generic.Instruction;
...
public class EditInfoController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("3".equals(role_id)) {
            ...
            iList = adb.getIntructorByUserName(username);
        } else {
            AccountDBContext adb = new AccountDBContext();
            stuList = adb.getStudentByUserName(username);
        }

        request.setAttribute("iList", iList);
        request.setAttribute("stuList", stuList);
        request.getRequestDispatcher("../staff/editinfo.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action.equals("add")) {
            ...
            boolean hasInsert = accDAO.editInformation(id, username, password,
