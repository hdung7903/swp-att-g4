...
public class AuthorInstructorFilter implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("AuthorInstructorFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("AuthorInstructorFilter:DoAfterProcessing");
        }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("AuthorInstructorFilter()");
        }
        StringBuffer sb = new StringBuffer("AuthorInstructorFilter(");
